...
//Write your code here
   try {
        ...
        res.status(500).json({ error: 'Error fetching Dealers records' });
    }
});
...
//Write your code here
   try {
        ...
        res.status(500).json({ error: 'Error fetching Dealers records by state' });
    }
...
//Write your code here
    try {
        ...
        res.status(500).json({ error: 'Error fetching Dealer record by id' });
    }
